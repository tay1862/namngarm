      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-24">
          ...
          <button
            ...
            className="md:hidden p-3 rounded-2xl hover:bg-pink-100 dark:hover:bg-pink-900/30 transition-colors duration-200"
        ...
        {isOpen && (
          <div
            ref={mobileMenuRef}
            id="mobile-menu"
            className="md:hidden py-6 space-y-2 border-t border-pink-200 dark:border-pink-800 mt-4"
            role={ariaRoles.MENU}
          ...
          >
            {navigation.map((item) => (
              <div key={item.href}>
                <Link
                  href={item.href}
                  className={`block px-6 py-4 rounded-2xl transition-all duration-200 ${pathname === item.href
