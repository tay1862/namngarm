...
export async function PUT(request: NextRequest) {
  try {
    ...
    const allowedFields = [
      'siteName_lo', 'siteName_en',
      'logo', 'favicon', 'homeBg', 'aboutBg', 'productsBg', 'articlesBg',
      'heroWelcome_lo', 'heroWelcome_en',
      'heroTitle_lo', 'heroTitle_en',
      'heroSubtitle_lo', 'heroSubtitle_en',
      'heroDesignImage',
      'email', 'phone',
      'address_lo', 'address_en',
      'whatsapp', 'whatsappMessage_lo', 'whatsappMessage_en',
      'facebookPage', 'lineId',
      'defaultMetaDesc_lo', 'defaultMetaDesc_en',
      'googleAnalyticsId', 'facebookPixelId',
      'isUnderMaintenance',
      'maintenanceMessage_lo', 'maintenanceMessage_en'
    ];
