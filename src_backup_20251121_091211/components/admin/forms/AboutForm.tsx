...
interface AboutPageData {
  ...
  founderName_zh?: string;
  founderName_en?: string;
  founderQuote_lo?: string;
  founderQuote_th?: string;
  founderQuote_zh?: string;
...
export default function AboutForm({ initialData }: AboutFormProps) {
  ...
  const [formData, setFormData] = useState<AboutPageData>({
    ...
    founderName_lo: initialData?.founderName_lo || '',
    founderName_th: initialData?.founderName_th || '',
    founderName_zh: initialData?.founderName_zh || '',
    founderName_en: initialData?.founderName_en || '',
    founderQuote_lo: initialData?.founderQuote_lo || '',
    founderQuote_th: initialData?.founderQuote_th || '',
    founderQuote_zh: initialData?.founderQuote_zh || '',
    founderQuote_en: initialData?.founderQuote_en || '',
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      {/* Founder Section */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-xl font-semibold mb-4 text-gray-900">Founder Section</h2>

        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-1">Founder Image</label>
          <ImagePicker
            value={formData.founderImage || ''}
            onChange={(url) => setFormData(prev => ({ ...prev, founderImage: url }))}
            folder="about"
          />
        </div>

        <div className="mb-6">
          <h3 className="text-lg font-medium mb-3 text-gray-800">Founder Name</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Lao</label>
              <input
        ...
        <div>
          <h3 className="text-lg font-medium mb-3 text-gray-800">Founder Quote</h3>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Lao</label>
              <textarea
                name="founderQuote_lo"
                value={formData.founderQuote_lo}
                onChange={handleChange}
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
                placeholder="A meaningful quote from the founder..."
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Thai</label>
              <textarea
                name="founderQuote_th"
                value={formData.founderQuote_th}
                onChange={handleChange}
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
                placeholder="A meaningful quote from the founder..."
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Chinese</label>
              <textarea
                name="founderQuote_zh"
                value={formData.founderQuote_zh}
                onChange={handleChange}
                rows={2}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
                placeholder="A meaningful quote from the founder..."
