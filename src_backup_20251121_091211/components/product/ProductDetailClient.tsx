...
import { ShoppingBag, Heart, Share2, ChevronDown, Check, Star, ShieldCheck, Truck, RefreshCw } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-12">
                            ...
                            <button className="flex-1 bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full font-medium shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-all duration-300 flex items-center justify-center gap-2 group">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
                            <div className="flex items-start gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700">
                                <div className="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 rounded-full">
                                    <Truck size={20} />
                                </div>
                                <div>
                                    <h4 className="font-medium text-gray-900 dark:text-white text-sm">Fast Shipping</h4>
                                    <p className="text-xs text-gray-500 mt-1">Delivery in 1-3 business days</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700">
