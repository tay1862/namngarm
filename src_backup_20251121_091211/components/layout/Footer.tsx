    ...
    <footer className="bg-gradient-to-br from-pink-50 via-pink-100 to-pink-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-gray-700 dark:text-gray-200 relative overflow-hidden">
      ...
      <div className="container-custom py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-semibold mb-4 text-pink-600 dark:text-pink-400">{tNav('home')}</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold mb-4 text-pink-600 dark:text-pink-400">{tContact('getInTouch')}</h3>
            <ul className="space-y-2">
          ...
          {/* Social */}
          <div>
            <h3 className="font-semibold mb-4 text-pink-600 dark:text-pink-400">{tFooter('socialMedia')}</h3>
