...
export async function PUT(
  ...
  try {
    ...
    const {
      ...
      metaDescription_lo, metaDescription_th, metaDescription_zh, metaDescription_en,
      isPublished,
      isFeatured,
    } = body;
    ...
    const article = await prisma.article.update({
      ...
      data: {
        ...
        metaTitle_zh,
        metaTitle_en,
        metaDesc_lo: metaDescription_lo,
        metaDesc_th: metaDescription_th,
        metaDesc_zh: metaDescription_zh,
        metaDesc_en: metaDescription_en,
        isPublished,
        isFeatured,
