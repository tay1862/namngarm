    ...
    return (
        <ProductDetailClient
            product={{
                ...
                benefits_th: Array.isArray(product.benefits_th) ? product.benefits_th as string[] : undefined,
                benefits_zh: Array.isArray(product.benefits_zh) ? product.benefits_zh as string[] : undefined,
                ...
                howToUse_th: Array.isArray(product.howToUse_th) ? product.howToUse_th as string[] : undefined,
                howToUse_zh: Array.isArray(product.howToUse_zh) ? product.howToUse_zh as string[] : undefined,
